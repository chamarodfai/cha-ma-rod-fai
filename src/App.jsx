...
function App() {
  ...
  const [showDailySales, setShowDailySales] = useState(false) // หน้ายอดขายรายวันแยก
  ...
  const adminPassword = 'chamarodfai1020' // รหัสผ่านสำหรับผู้ดูแลระบบ
  ...
  const formatOrderId = (orderId) => {
    // แสดงหมายเลขออร์เดอร์แบบดิบไม่มีเครื่องหมาย เช่น 202507290001
    return orderId
  }
  ...
  const handlePasswordSubmit = () => {
    if (password === adminPassword) {
      ...
      setPendingAction('')
      // ตั้งเวลา logout อัตโนมัติหลัง 30 นาที
      setTimeout(() => {
        setIsAuthenticated(false)
        alert('หมดเวลาเซสชันแล้ว กรุณาใส่รหัสผ่านใหม่')
      }, 30 * 60 * 1000)
    } else {
  ...
  const executeAction = (action) => {
    switch(action) {
      ...
      case 'promotion-management':
        setShowPromotionManagement(true)
        break
      case 'analytics':
    ...
    <div className="min-h-screen thai-gradient-bg">
        ...
        <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0 relative z-10">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-4 overflow-x-auto">
            ...
            >
              ...
              <span className="hidden sm:inline md:hidden text-sm">เลือก</span>
            </button>
            <button
            ...
            >
              ...
              <span className="hidden sm:inline lg:hidden text-sm">จัดการ</span>
            </button>
            <button
            ...
            >
              ...
              <span className="hidden sm:inline md:hidden text-sm">วันนี้</span>
            </button>
            <button
            ...
            >
              ...
              <span className="hidden sm:inline md:hidden text-sm">ยอดขาย</span>
            </button>
      ...
      {showAnalytics && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg w-full max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
            <div className="p-3 sm:p-4 md:p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 space-y-2 sm:space-y-0">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 flex items-center space-x-2 sm:space-x-3">
                  <TrendingUp className="w-6 h-6 sm:w-8 sm:h-8 text-thai-orange" />
      ...
      {showReceipt && receiptData && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg max-w-xs sm:max-w-md w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
            <div className="p-4 sm:p-6">
              {/* Receipt Header */}
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg sm:text-xl font-bold text-gray-800">ใบเสร็จ</h2>
                <button
      ...
      {showPromotionManagement && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg w-full max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
            <div className="p-3 sm:p-4 md:p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 space-y-2 sm:space-y-0">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 flex items-center space-x-2 sm:space-x-3">
                  <Receipt className="w-6 h-6 sm:w-8 sm:h-8 text-thai-orange" />
      ...
      {showDailySales && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg w-full max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
            <div className="p-3 sm:p-4 md:p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 space-y-2 sm:space-y-0">
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 flex items-center space-x-2 sm:space-x-3">
                  <Calendar className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-green-600" />
                  <span className="text-sm sm:text-base md:text-lg lg:text-xl">ยอดขายวันนี้ - {new Date().toLocaleDateString('th-TH')}</span>
                </h2>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        ฿{Object.values(analyticsData.daily)[Object.keys(analyticsData.daily).length - 1]?.revenue?.toLocaleString() || '0'}
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-green-100 text-sm">กำไรวันนี้</p>
                      <p className="text-2xl font-bold">
                        ฿{Object.values(analyticsData.daily)[Object.keys(analyticsData.daily).length - 1]?.profit?.toLocaleString() || '0'}
                      </p>
                    </div>
                    <TrendingUp className="w-8 h-8 text-green-200" />
                  </div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-purple-100 text-sm">จำนวนออร์เดอร์</p>
                      <p className="text-2xl font-bold">
                        {Object.values(analyticsData.daily)[Object.keys(analyticsData.daily).length - 1]?.orders || '0'} ออร์เดอร์
                      </p>
                    </div>
                    <ShoppingCart className="w-8 h-8 text-purple-200" />
                  </div>
                ...
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-6 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-orange-100 text-sm">ยอดขายเฉลี่ย/ออร์เดอร์</p>
                      <p className="text-2xl font-bold">
                        ฿{(() => {
                          const todayData = Object.values(analyticsData.daily)[Object.keys(analyticsData.daily).length - 1]
                          const avgOrder = todayData?.orders > 0 ? (todayData.revenue / todayData.orders) : 0
                          return avgOrder.toFixed(0)
                        })()}
                      </p>
                    </div>
                                ...
                                <div className="space-y-1">
                                  ...
                                  {order.discount_amount > 0 && (
                                    <div className="flex justify-between text-sm text-red-600">
                                      <span>ส่วนลด:</span>
                                      <span>-฿{(order.discount_amount || 0).toFixed(0)}</span>
                                    </div>
                                  )}
                                  <div className="flex justify-between font-semibold text-lg">
                                    <span>ยอดสุทธิ:</span>
                                    <span className="text-green-600">฿{(order.final_total || order.total || 0).toFixed(0)}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4 h-full">
              ...
              <div className="w-full lg:w-[70%]">
                <div className="card h-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-3 lg:gap-4 max-h-[60vh] overflow-y-auto">
              ...
              <div className="w-full lg:w-[30%]">
                <div className="card h-full">
                  <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800">ท็อปปิ้ง</h3>
                  
                  {selectedDrink && (
                    <div className="mb-3 sm:mb-4 p-2 sm:p-3 bg-orange-50 rounded-lg border border-orange-200">
                      <p className="text-xs sm:text-sm text-gray-600">เลือกแล้ว:</p>
                      <p className="font-semibold text-gray-800 text-sm sm:text-base">{selectedDrink.name}</p>
                      <p className="text-thai-orange font-bold text-sm sm:text-base">{selectedDrink.price}฿</p>
                    </div>
                  )}
                  ...
                  <div className="space-y-2 max-h-[40vh] sm:max-h-[50vh] overflow-y-auto">
                    {menuItems.filter(item => item.category === 'Topping').map(topping => {
                      ...
                      return (
                        <div 
                          key={topping.id} 
                          className={`p-2 sm:p-3 border rounded-lg cursor-pointer transition-all min-h-[44px] ${
                            isSelected 
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <div>
                              <p className="font-medium text-gray-800 text-sm sm:text-base">{topping.name}</p>
                              <p className="text-xs sm:text-sm text-thai-orange">+{topping.price}฿</p>
                            </div>
                            {isSelected && (
                              <button 
                  ...
                  {selectedDrink && (
                    <div className="mt-4 pt-4 border-t">
                      ...
                      <button 
                        ...
                        className="w-full bg-thai-orange hover:bg-orange-600 text-white py-3 px-4 rounded-lg font-medium text-sm sm:text-base min-h-[44px]"
                      >
                        เพิ่มลงตะกร้า
                      </button>
                    </div>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full btn-primary flex items-center justify-center min-h-[44px] text-sm sm:text-base"
                    >
                    ...
                    <button
                      onClick={clearCart}
                      className="w-full btn-secondary min-h-[44px] text-sm sm:text-base"
                    >
                      ล้างตะกร้า
                    </button>
                  </div>
      ...
      {showConfirmModal && selectedDrink && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-xs sm:max-w-md">
            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4">ยืนยันการสั่ง</h3>
            ...
            <div className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-2 sm:space-y-0">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-800 flex items-center space-x-2">
                  <Receipt className="w-6 h-6 text-thai-orange" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {cart.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {cart.map((item, index) => (
                        <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-thai-orange font-semibold">{item.price}฿</p>
                          </div>
                          <div className="text-right">
                      ...
                      <div className="border-t pt-3 mt-4">
                        <div className="flex justify-between items-center text-lg font-bold">
                          <span>ยอดรวม:</span>
                          <span className="text-thai-orange">{cart.reduce((sum, item) => sum + item.price * item.quantity, 0)}฿</span>
                        </div>
                        
                        {selectedPromotion && (
                          <div className="mt-2 p-2 bg-green-50 rounded-lg border border-green-200">
                            <p className="text-sm text-green-700">
                              ใช้โปรโมชั่น: {selectedPromotion.name} 
                              (-{selectedPromotion.type === 'percentage' ? selectedPromotion.value + '%' : selectedPromotion.value + '฿'})
                            </p>
                            <p className="text-lg font-bold text-green-600">
                              ยอดสุทธิ: {getFinalPrice()}฿
                            </p>
                          </div>
                        )}
                      </div>
                ...
                <div className="card">
                  <h3 className="text-lg font-semibold mb-4 text-gray-800 flex items-center space-x-2">
                    <Receipt className="w-5 h-5 text-thai-orange" />
                    <span>เลือกโปรโมชั่น</span>
                  </h3>
